...
namespace Predictions
{
    public class Predictions
    {
        ...
        {
            Vector3 chuot = Prediction.GetPrediction(target, 100).CastPosition;
            float dis = from.Distance(target.Position);
        ...
        {
            var chuot = Prediction.GetPrediction(target, 100).CastPosition;
    ...
    public class Collisions
    {
        ...
        public static List<Obj_AI_Base> GetCollisions(Vector3 from, Vector3 to, Spells spell)
        {
                                                ...
                                                gameObject.Name, "_w_windwall_enemy_0.\\.troy", RegexOptions.IgnoreCase)))
            {
                ...
                if (x.Intersects == true) result.Add(ObjectManager.Player);else
                {
                    Vector2 y;
